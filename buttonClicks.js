const XPButtons = [ //The stats of every single xp button
  ...
  {name: "XPbutton1", xp: 1, cooldown: 20, cooldownID: 0, unlock: 0},
  {name: "XPbutton2", xp: 2, cooldown: 40, cooldownID: 1, unlock: 1},
  {name: "XPbutton3", xp: 3, cooldown: 80, cooldownID: 2, unlock: 2},
  {name: "XPbutton4", xp: 5, cooldown: 160, cooldownID: 3, unlock: 3},
  {name: "XPbutton5", xp: 10, cooldown: 320, cooldownID: 4, unlock: 4},
  {name: "XPbutton6", xp: 20, cooldown: 640, cooldownID: 5, unlock: 5},
  {name: "XPbutton7", xp: 50, cooldown: 1280, cooldownID: 11, unlock: 8},
  {name: "XPbutton8", xp: 100, cooldown: 2560, cooldownID: 14, unlock: 10},
  {name: "XPbutton9", xp: 150, cooldown: 5120, cooldownID: 16, unlock: 12},
  {name: "XPbutton10", xp: 250, cooldown: 10240, cooldownID: 17, unlock: 15},
  {name: "XPbutton11", xp: 500, cooldown: 20480, cooldownID: 39, unlock: 17},
  {name: "XPbutton12", xp: 1000, cooldown: 40960, cooldownID: 40, unlock: 18},
]
...
const StatButtons = [
  ...
  {name: "StatButton1", stats: 15, cooldown: 2, cooldownID: 20, unlock: 21},
